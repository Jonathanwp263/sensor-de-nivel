...
/**
  * @brief Initializes Commands interface and the HardwareSerial object on given Rx/Tx pins and Baudrate
  * @param rxPin: Serial Rx pin
  * @param txPin: Serial Tx pin
  * @param baudRate: Serial baudrate, in bps
  * @retval pointer to the HardwareSerial object
  */
HardwareSerial* SerialCommandsInit(uint8_t rxPin, uint8_t txPin, uint32_t baudRate, uint8_t uart = 2);



/**
  * @brief Initializes Transparent interface and the HardwareSerial object on given Rx/Tx pins and Baudrate
  * @param rxPin: Serial Rx pin
  * @param txPin: Serial Tx pin
  * @param baudRate: Serial baudrate, in bps
  * @retval pointer to the HardwareSerial object
  */
HardwareSerial* SerialTranspInit(uint8_t rxPin, uint8_t txPin, uint32_t baudRate, uint8_t uart = 1);
...
/**
  ...
  * @param pull: internal pull resistor mode (PULL_OFF, PULLUP_MOTE, PULLDOWN_MOTE)
  * @retval MESH_OK or MESH_ERROR
  */
